-- Migration: Create Character Tables
...
CREATE INDEX idx_characters_season_id ON characters(season_id);
...
CREATE INDEX idx_character_associations_location_id ON character_associations(location_id);
CREATE INDEX idx_character_associations_organization_id ON character_associations(organization_id);
CREATE INDEX idx_character_associations_item_id ON character_associations(item_id);
CREATE INDEX idx_character_associations_event_id ON character_associations(event_id);
