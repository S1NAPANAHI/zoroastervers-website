...
-- Insert sample admin user (you should update this with your actual admin email)
INSERT INTO users (
  id, 
  username, 
  email, 
  ...
  'admin-user-id', -- You'll need to replace this with actual UUID after creating the user
  'SinaPanahi',
  'admin@zoroaster.com',
  '👑',
  'Creator and administrator of the ZOROASTER universe.',
  'admin',
  true,
  ARRAY['Universe Creator', 'Admin', 'Author'],
  '[{"id": "universe-creator", "name": "Universe Creator", "description": "Created the entire ZOROASTER universe", "icon": "🌌", "unlockedAt": "2024-01-01", "category": "lore"}]'::jsonb,
  '{"booksRead": 5, "totalBooks": 5, "timelineExplored": 100, "charactersDiscovered": 100, "locationsExplored": 100}'::jsonb
